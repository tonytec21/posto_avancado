				...
				<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-3">
								<?php if ($dados['status'] == 'ACV'): ?>
									<a class="btn btn-info btn-lg btn-block" href="obito-acervo.php?id=<?=$dados['ID']?>">
										<i style="font-size:50px" class="fa fa-pencil-square-o"></i><br>		
										ACESSAR FORMULÁRIO DE DADOS
									</a>
								<?php else: ?>
									<a class="btn btn-info btn-lg btn-block" href="obito-registro.php?id=<?=$dados['ID']?>">
										<i style="font-size:50px" class="fa fa-pencil-square-o"></i><br>		
										ACESSAR FORMULÁRIO DE DADOS
									</a>
								<?php endif ?>
					...
					<div class="card col-lg-12">
						...
						<div class="row">
							<?php if ($dados['TIPOLIVRO'] == '4'): ?>
								<div class="col-lg-3">
									<a  style="color:#525f7f; background: transparent!important;" class="btn  btn-lg btn-block" onclick="window.open('print-obito.php?id=<?=$id?>&tiporegistro=1')">
								...
								<div class="col-lg-3">
									<a  style="color:#525f7f; background: transparent!important;" class="btn  btn-lg btn-block" onclick="window.open('print-obito.php?id=<?=$id?>&tiporegistro=4')">
										<i style="font-size:65px; " class="fa fa-file-text"></i><br><br>		
										ASSENTO DE OBITO VERSÃO 2
									</a>
								</div>
							<?php else: ?>
								<div class="col-lg-3">
									<a  style="color:#525f7f; background: transparent!important;" class="btn  btn-lg btn-block" onclick="window.open('print-obito.php?id=<?=$id?>&tiporegistro=2')">
										<i style="font-size:65px; " class="fa fa-file-text"></i><br><br>		
										ASSENTO DE NATIMORTO
									</a>
								</div>

								<div class="col-lg-3">
									<a  style="color:#525f7f; background: transparent!important;" class="btn  btn-lg btn-block" onclick="window.open('print-obito.php?id=<?=$id?>&tiporegistro=5')">
										<i style="font-size:65px; " class="fa fa-file-text"></i><br><br>		
										ASSENTO DE NATIMORTO VERSÃO 2
									</a>
								</div>
							<?php endif ?>
							...
							<div class="col-lg-3">
								<a  style="color:#525f7f; background: transparent!important;" class="btn  btn-lg btn-block" onclick="$('#comunicacaoset').modal();">
									<i style="font-size:65px; " class="fa fa-file-text"></i><br><br>		
						...
						<?php if ($dados['status'] == 'ACV'):?>
								<div class="col-lg-12">
									<a style="color:white" class="btn btn-danger btn-lg btn-block" onclick="fquerybd('delete from registro_obito_novo where ID = <?=$dados['ID']?>', 'EXCLUIR')" >
					...
					<?php else: ?>
						<span style="color:red; font-weight:bold; text-align: center;">
							<?=buscamotivocancelamento($id, 'obt')?>
						</span>
					<?php endif ?>
					</div>		
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="formcertidao" target="blank" method="POST" action="certidao-obito.php?id=<?=$id?>&tiporegistro=2">
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<select onchange="tipocertidao($(this).val())" id="TIPOCERTIDAO" name="TIPOCERTIDAO" class="form-control valid" required="true">
								...
								<option value="1">CERTIDÃO DE OBITO PRIMEIRA VIA</option>
								<option value="3">CERTIDÃO DE INTEIRO TEOR</option>
								<option value="2">CERTIDÃO DE OBITO SEGUNDA VIA</option>
								<option value="6">CERTIDÃO XML (CRC)</option>
								<option value="7">CERTIDÃO DE OBITO PRIMEIRA VIA RESTAURAÇÃO</option>
							</select>  
						</div>
						...
						<!--div class="col-lg-12 prim_via" style="display:none">
							<br><br>
							<a onclick="window.open('certidao-obito.php?id=<?=$id?>&tiporegistro=1')" class="btn btn-info btn-lg btn-block" href=""> <i style="font-size:40px" class="fa fa-print"></i><br> IR PARA CERTIDÃO</a>
						</div-->
...
<div id="comunicacaoset" class="modal fade"  tabindex="-1" role="dialog"   aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form action="print-obito.php?id=<?=$id?>&tiporegistro=3" method="POST" target="_blank">
				<div class="row">

					<div class="col-lg-12">
						<label for="country">ENDEREÇADO A:</label>
						<textarea id="ENDERECADO" name="ENDERECADO" class="form-control" placeholder="RAZÃO SOCIAL, ENDEREÇO, COMARCA..."></textarea>		
					</div>

					<div class="col-lg-12">
						<label for="country">DADOS REGISTRO NASCIMENTO:</label>
						<textarea id="DADOSNASCIMENTO" name="DADOSNASCIMENTO" class="form-control" placeholder="LIVRO, FOLHA, TERMO, DATA DO NASCIMENTO, DO NUBENTE"></textarea>		
					</div>


					<div class="col-lg-12">
						<br><br>
						<button class="btn btn-block btn-info">EMITIR</button>
					</div>
				</form>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-12">
          	<form method="POST" action="control/cancelar-obito.php?id=<?=$id?>">
