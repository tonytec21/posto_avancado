...
header('location:../notas-lavratura-cep-escritura-doacao.php?conf1=ok&id='.$id);
...
//fechar parte 4
if (isset($_POST['strInfoImovel']) || $_POST['strInfoImovel'] =! '? undefined:undefined ?' ) {
...
if (isset($_POST['dataInfoImovel']) || $_POST['dataInfoImovel'] =! '? undefined:undefined ?' ) {
...
if (isset($_POST['strInfoImovelCertidao']) || $_POST['strInfoImovelCertidao'] =! '? undefined:undefined ?' ) {
...
if (isset($_POST['guiaItcmdDATA']) || $_POST['guiaItcmdDATA'] =! '? undefined:undefined ?' ) {

	$guiaItcmdDATA = $_POST['guiaItcmdDATA'];

}else {
	$guiaItcmdDATA= '1111-11-11';
}
$guiaItcmdDATA = date('Y/m/d', strtotime($guiaItcmdDATA));

if (isset($_POST['guiaItcmdImovel']) || $_POST['guiaItcmdImovel'] =! '? undefined:undefined ?' ) {

	$guiaItcmdImovel = $_POST['guiaItcmdImovel'];

}else {
	$guiaItcmdImovel= NULL;
}
if (isset($_POST['doacaoInfoImovel']) || $_POST['doacaoInfoImovel'] =! '? undefined:undefined ?' ) {

	$doacaoInfoImovel = $_POST['doacaoInfoImovel'];

}else {
	$doacaoInfoImovel= NULL;
}
//imoveis
...
UPDATE_CAMPO_ID('notas_lavratura','guiaItcmdDATA',$guiaItcmdDATA,$id);
UPDATE_CAMPO_ID('notas_lavratura','guiaItcmdImovel',$guiaItcmdImovel,$id);
UPDATE_CAMPO_ID('notas_lavratura','doacaoInfoImovel',$doacaoInfoImovel,$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cep-escritura-doacao.php?conf4=ok&id='.$id);
...
header('location:../notas-lavratura-cep-escritura-doacao.php?conf3=ok&id='.$id);
