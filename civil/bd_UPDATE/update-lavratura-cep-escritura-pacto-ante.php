...
header('location:../notas-lavratura-cep-escritura-pacto-ante.php?conf1=ok&id='.$id);
...
if (isset($_POST['setRegimeBens']) || $_POST['setRegimeBens'] =! '? undefined:undefined ?' ) {
...
UPDATE_CAMPO_ID('notas_lavratura','setRegimeBens',$strRetificacao,$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cep-escritura-pacto-ante.php?conf4=ok&id='.$id);
...
header('location:../notas-lavratura-cep-escritura-pacto-ante.php?conf3=ok&id='.$id);
