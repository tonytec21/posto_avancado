...
<br><br><br><br><br><br><br>
												...
												<h1 style="text-align: center"> CERTIDÃO DE INTERDIÇÃO</h1>
												<br>
...
Certifico que no livro E-<?=$r->LIVROESPECIAL?>, folha <?=$r->FOLHAESPECIAL?> e registro <?=$r->TERMOESPECIAL?>, de Registro de Emancipação, Interdição e Ausência, deste Ofício, consta que foi lavrado aos 	
													...
													?>, o assento de interdição de:  <p style="text-align: center; font-weight: bold"><?=$r->NOME?></p>,<br> registrado neste Ofício no Livro de nº <?=$r->LIVROREGISTRONASCIMENTO?>, Folha <?=$r->FOLHAREGISTRONASCIMENTO?>,  Conforme mandado judicial expedido pelo(a) Exmo(a). Juiz(a) <?=$r->JUIZ?>, foi nomeado curador <?=$r->NOMECURADOR?>, 
