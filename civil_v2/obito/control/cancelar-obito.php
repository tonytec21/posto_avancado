...
$in_table_add = $pdo->prepare("INSERT INTO `bookc`.`info_registros_civil` (`id_registro_obito`, `inteiro_teor`, `observacoes_registro`, `obs_visivel_certidao`) VALUES ('$id', '', '$motivo', 'C');");
	$in_table_add->execute();

UPDATE_CAMPO_ID("registro_obito_novo", "status", "CAN", $id);
