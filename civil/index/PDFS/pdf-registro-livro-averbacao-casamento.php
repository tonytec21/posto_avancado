...
include('menu.php');  include('../../../controller/db_functions.php'); $pdo=conectar();  ?>
...
$livro = $_GET['livro'];
$folha = $_GET['folha'];
if ($_GET['relig'] != '1111-11-11') {
$busca_registro =$pdo->prepare("SELECT * FROM livro_casamentos_auxiliar where identifcadorLivro = '$livro' and PaginaLivro = '$folha' " ); } 

else{$busca_registro =$pdo->prepare("SELECT * FROM livro_casamentos where identifcadorLivro = '$livro' and PaginaLivro = '$folha' "); }
...
<?php endforeach ?>
<?php 
 $bn = $pdo->prepare("SELECT * FROM averbacoes_civil where strLivro = $livro and strFolha = $folha and Conjuge1 != 'NULL' and Conjuge2 !='NULL'");
                        $bn->execute(); 
