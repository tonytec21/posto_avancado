...
body{font-size: 13px;font-family: "Arial";margin-left: 2cm;margin-bottom: -10cm;
...
<?php if ($r->TIPOASSENTO != 'ORDEM' && $r->TIPOASSENTO != 'UNIDADE_INTERLIGADA' ): ?>	
		<!--REGISTRO NASCIMENTO LIVRO BASICO #################################################################################################################-->	
												...
												<!--TIPOS DE DECLARANTES-->
														...
														<?php if (intval($r->NATURALIDADEDECLARANTE) == "5300109"): ?>
															<span style="text-transform: capitalize;"><?=str_replace($tirar_cidades,$repor_cidades,$r->NATURALIDADEDECLARANTE)?></span>
														<?php else: ?>
													...
													<!--	
														...
														<?php endif ?><?php endif ?>
														residente e domiciliado em <span style="text-transform: capitalize;"><?=mb_strtolower($r->ENDERECODECLARANTE)?>, <?=mb_strtolower($r->BAIRRODECLARANTE)?>,</span> 

														<?php  $c = PESQUISA_ALL_ID('uf_cidade',intval($r->CIDADEDECLARANTE)); foreach($c as $c):?>
														<?php if (intval($r->CIDADEDECLARANTE) == "5300109"): ?>
															<span style="text-transform: capitalize;"><?=str_replace($tirar_cidades,$repor_cidades,$r->CIDADEDECLARANTE)?></span>
														<?php else: ?>
														<span style="text-transform: capitalize;"><?=mb_strtolower($c->cidade)?></span>/<?=$c->uf?>,
														<?php endif ?>
														<?php endforeach ?>
													...
													<?php endif ?> com CPF de número <?=$r->CPFNASCIDO?>, natural de <?php  $c = PESQUISA_ALL_ID('uf_cidade',intval($r->NATURALIDADENASCIDO)); foreach($c as $c):?>
														<?php if (intval($r->NATURALIDADENASCIDO) == "5300109"): ?>
															<span style="text-transform: capitalize;"><?=str_replace($tirar_cidades,$repor_cidades,$r->NATURALIDADENASCIDO)?></span>
														<?php else: ?>
														<span style="text-transform: capitalize;"><?=mb_strtolower($c->cidade)?></span>/<?=$c->uf?>,
														<?php endif ?>
													...
													<!--	
														...
														<?php if (intval($r->CIDADEPAI) == "5300109"): ?>
															<span style="text-transform: capitalize;"><?=str_replace($tirar_cidades,$repor_cidades,$r->CIDADEPAI)?></span>
														<?php else: ?>
														<span style="text-transform: capitalize;"><?=mb_strtolower($c->cidade)?></span>/<?=$c->uf?>,
												...
												<!--
														...
														<?php endif ?>
														<?php if ($r->DATANASCIMENTOMAE!=''): ?>
														com <?=idade_civil_antigo($r->DATANASCIMENTOMAE, $r->DATANASCIMENTO)?> anos de idade na ocasião do parto, e agora com <?=idade_civil_antigo($r->DATANASCIMENTOMAE,$r->DATAENTRADA)?> anos de idade,
														...
														<?php if (intval($r->CIDADEMAE) == "5300109"): ?>
															<span style="text-transform: capitalize;"><?=str_replace($tirar_cidades,$repor_cidades,$r->CIDADEMAE)?></span>
														<?php else: ?>
														<span style="text-transform: capitalize;"><?=mb_strtolower($c->cidade)?></span>/<?=$c->uf?>,
														<?php endif ?><?php endforeach ?>
														...
														<?php if (intval($r->NATURALIDADEPAISOCIO) == "5300109"): ?>
															<span style="text-transform: capitalize;"><?=str_replace($tirar_cidades,$repor_cidades,$r->NATURALIDADEPAISOCIO)?></span>
														<?php else: ?>
														<span style="text-transform: capitalize;"><?=mb_strtolower($c->cidade)?></span>/<?=$c->uf?>,
														<?php endif ?>
														<?php endforeach ?> 
													<!--
														...
														<?php if (intval($r->CIDADEPAISOCIO) == "5300109"): ?>
															<span style="text-transform: capitalize;"><?=str_replace($tirar_cidades,$repor_cidades,$r->CIDADEPAISOCIO)?></span>
														<?php else: ?>
														<span style="text-transform: capitalize;"><?=mb_strtolower($c->cidade)?></span>/<?=$c->uf?>,
														<?php endif ?>
														<?php endforeach ?>	  
...
<!--
	 	...
	 	<table style="border: none; display: inline-block; margin-left: 40px; width: 50%; margin-bottom: -30px">
				...
				<tr style="border: none">
					<td style="border: none;text-align: center;">DIGITAL <?=mb_strtoupper($r->NOMEMAE)?> </td>
					<td style="border: none; text-align: center; "><p style="margin-top: -40px"><?=mb_strtoupper($b->strNome)?></p></td>
				</tr>
			</table>
			<br><br><br>
...
<!--
	 	...
	 	<table style="border: none; display: inline-block; margin-left: 40px; width: 50%; margin-bottom: -30px">
				...
				<tr style="border: none">
					<td style="border: none;text-align: center;">DIGITAL <?=mb_strtoupper($r->NOMEDECLARANTE)?> </td>
					<td style="border: none; text-align: center; "><p style="margin-top: -40px"><?=mb_strtoupper($b->strNome)?></p></td>
				</tr>
			</table>
			<br><br><br>
		...
		<?php endif ?>	
												...
												<br><br>
													<p style="text-align: center; margin-top: -50px;">_____________________________________</p>
...
<table style="border:none; max-width: 60%;margin-left: 15%; border:none!important">
<tr style="border:none">
