  ...
  <section style="margin-top: -3%;">
      <div class="row">
        <div class="section section-components col-lg-7">
          <div class="container">
              <div class="header"><h3 class="">REGISTRO DE ÓBITO</h3>
              </div>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="nav-wrapper">
                    <ul class="nav nav-pills nav-fill flex-column flex-md-row col-lg-12" id="tabs-icons-text" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab" data-toggle="tab" href="#dadosfalecido" role="tab" aria-controls="dadosfalecido" aria-selected="true"><i class="fa fa-book"></i> DADOS DO ÓBITO</a>
                      </li>
                  ...
                  <div class="">
                    <div class="card-body">
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="dadosfalecido" role="tabpanel" aria-labelledby="dadosfalecido-tab">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <label for="country">NUM DECLARAÇÃO DE ÓBITO:</label>
                                  <input onblur="campos_input($(this).attr('id'), '<?=$id?>')" type="text" id="NDO" name="NDO" class="form-control ndo " placeholder=" ">
                            </div>
        ...
        <div class="section section-components col-lg-5">
          <div class="container">
              ...
              <hr>
              <div class="header"><h6>PRÉ VISUALIZAÇÃO</h6></div>
