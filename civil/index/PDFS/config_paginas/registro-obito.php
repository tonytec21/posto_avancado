...
body{text-transform: uppercase; padding-top: 6.5cm; padding-bottom: 1cm; padding-left: 2cm; padding-right: 2cm;zoom:80%;}
</style>
</head>
...
<br>
<fieldset style="padding: 15px;margin-top: 5px;margin-right: 0px;"><legend>AVERBAÇÕES/ANOTAÇÕES A ACRESCER</legend>
Observações:
