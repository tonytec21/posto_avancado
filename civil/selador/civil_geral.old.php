...
#PARTE 1 OBTENDO O TOKEN DE ACESSO:
                ...
                $ConteudoPOST = "username=homologacao&password=a907438c85f0&client_id=selador&grant_type=password";
                $ConteudoCabecalho = [
 ...
 curl_setopt_array($curl, array(
   ...
   CURLOPT_POSTFIELDS => "username=homologacao&password=a907438c85f0&client_id=selador&grant_type=password",
