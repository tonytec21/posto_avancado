...
$qntOutorgante = $_POST['quantidadeOutorgante'];
...
UPDATE_CAMPO_ID('notas_lavratura','possuiDOI',$possuiDOI,$id);
...
header('location:../notas-lavratura-cep-escritura.php?conf1=ok&id='.$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strInfoAdicionais',$strInfoAdicionais,$id);
UPDATE_CAMPO_ID('notas_lavratura','strEspolio',$strEspolio,$id);
UPDATE_CAMPO_ID('notas_lavratura','strRetificacao',$strRetificacao,$id);
...
UPDATE_CAMPO_ID('notas_lavratura','setAssinaParte3',mb_strtoupper($setAssinaParte3),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','setAssinaParte4',mb_strtoupper($setAssinaParte4),$id);
...
$insert_auditoria = $pdo->prepare("INSERT into auditoria values (NULL,'$funcionario','ESCRITURA','1','1','$seloExplode[$i]',CURRENT_TIMESTAMP,'$tipoSelo','$desTipoAto[$i]','$numLivro','$numFolha','$numOrdem','0','0','0')");
...
header('location:../notas-lavratura-cep-escritura.php?conf3=ok&id='.$id);
