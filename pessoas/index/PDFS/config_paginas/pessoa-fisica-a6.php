...
"versaoTabelaDeCustas":"0520201012",
"partes": {
"nomesPartes":"X",
"parteAto":[
{
...
<body>
	...
	if (!isset($_SESSION['RETORNOTEMP']) && $key->RETORNOSELODIGITAL=='') {
...
<fieldset style="width:100%;margin-bottom: -1cm;border: 0px solid white">
...
<td style="width: 20%; font-size: 60%">
<?php if (isset($key->hiddencaminhofoto) && !empty($key->hiddencaminhofoto) && $key->hiddencaminhofoto != 'NULL'): ?>
		<div style="margin-top:0px">
		<img style="width: 60px; height: 40px;" src="../<?=$key->hiddencaminhofoto?>">
		</div>
<?php else: ?>

	<h3 style="max-width: 100%; opacity: .5">
		FOTO NÃO INSERIDA
	</h3>
...
<fieldset style="height:2px;width: 100%;font-size:9px;text-align:left" ><legend>NOME</legend> <?=mb_strtoupper($key->strNome)?></fieldset>
...
<fieldset style="height:2px;width: 20%; display: inline-block;font-size:8px"><legend>NATURALIDADE</legend>
	...
	<?php $e = PESQUISA_ALL_ID('uf_cidade',intval($key->strNaturalidade)); foreach ($e as $e):?><?=$e->cidade.'/'.$e->uf?> <?php endforeach ?>
...
<fieldset style="margin-top:7.7px;height:2px;width: 20.5%; display: inline-block;font-size:9px;position:absolute"><legend>DATA NASCIMENTO</legend> <?=strtoupper( date('d/m/Y', strtotime($key->dataNascimento)))?></fieldset>
</div>
...
<fieldset style="height:2px;width: 20%; display: inline-block;font-size:9px"><legend>DATA EMISSÃO</legend><?=strtoupper(date('d/m/Y', strtotime($key->dataEmissao)))?> </fieldset>

<fieldset style="height:2px;width: 20.46%; display: inline-block;font-size:9px"><legend>CPF/CNPJ</legend> <?=strtoupper($key->strCPFcnpj)?></fieldset>
</div>
...
<fieldset style="height:2px;width: 20%; display: inline-block;font-size:8px"><legend>CIDADE</legend><div style="margin-top:-3px;">
	<?php $e = PESQUISA_ALL_ID('uf_cidade',intval($key->intUFcidade)); foreach ($e as $e):?><?=$e->cidade.'/'.$e->uf?> <?php endforeach ?>
</div>
...
<fieldset style="height:2px;width: 67.6%; display: inline-block;font-size:9px"><legend>Conjuge</legend><?=strtoupper($key->strNomeConjuge)?></fieldset>
</div>
...
<fieldset style="height:2px;width: 31.95%; display: inline-block;font-size:9px"><legend>TEL/CEL</legend> <?=strtoupper($key->strTelefone.' || '.$key->strTelCelular)?></fieldset>
<fieldset style="height:2px;width: 31.95%; display: inline-block;font-size:9px"><legend>EMAIL</legend> <?=strtoupper($key->strEmail)?></fieldset>
</div>

<br><br>
<fieldset style="height:9px;width: 100%;font-size:9px;text-align:left; border: none" ><legend>ASSINATURA 1</legend><hr  style="border: 0.1px solid black;"></fieldset>
<br>
<fieldset style="height:9px;width: 100%;font-size:9px;text-align:left; border: none" ><legend>ASSINATURA 2</legend><hr style="border: 0.1px solid black;"></fieldset>
<br>
<fieldset style="height:9px;width: 100%;font-size:9px;text-align:left;border:none" ><legend>ASSINATURA 3 OU RUBRICA</legend><hr style="border: 0.1px solid black;"></fieldset>
<!-- <p style="width:300px;font-size:6px !important;position:absolute;padding-top:-4%">	<?=corrigir_acento_m4($textoselo)?></p> -->

<p style="margin-left: -60%; font-size: 60%;padding-top:4px;">SELO: <?=strtoupper($strSelo)?></p>

<p style="margin-left: 50%; margin-top: -30px;font-size: 60%;">
 _________________________________________________<br>  <?=mb_convert_case($_SESSION['nome'], MB_CASE_UPPER, "UTF-8")?></p>
<p>
...
<?php if ($key->setTipoPessoa =='J'): ?>
	...
	___________________________________________
	 ...
	 <p style="margin-left: -60%; font-size: 60%;padding-top:2px; width:300px">SELO: <?=strtoupper($strSelo)?>
		<?=$textoselo?>
		 </p>
