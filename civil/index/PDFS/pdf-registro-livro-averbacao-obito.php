...
$livro = $_GET['livro'];
$folha = $_GET['folha'];
if ($_GET['nati'] != '' && $_GET['nati'] != NULL ) {
$busca_registro =$pdo->prepare("SELECT * FROM livro_obitos_auxiliar where identifcadorLivro = '$livro' and PaginaLivro = '$folha' " ); } 

else{$busca_registro =$pdo->prepare("SELECT * FROM livro_obitos where identifcadorLivro = '$livro' and PaginaLivro = '$folha' "); }
...
<?php endforeach ?>
<?php 
 $bn = $pdo->prepare("SELECT * FROM averbacoes_civil where strLivro = $livro and strFolha = $folha and dataObito !=''");
                        $bn->execute(); 
