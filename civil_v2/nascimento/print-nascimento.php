				...
				<div class="container">
					...
					<textarea class="tinymce-500" id="texto_nascimento" name="texto_nascimento">
						...
						<?php if ($_GET['tiporegistro'] == '1'): ?>
							...
							include_once('pdfs/registro-nascimento-livro.php'); 
							}
							?>
						<?php elseif ($_GET['tiporegistro'] == '2'): ?>
							<?php include_once('pdfs/registro-nascimento-supostopai.php') ?>
						<?php elseif ($_GET['tiporegistro'] == '3'): ?>
							<?php include_once('pdfs/registro-nascimento-negacaopaternidade.php') ?>
						<?php elseif ($_GET['tiporegistro'] == '4'): ?>
							...
							if ($busca_ja_existe->rowCount()!=0) {
								...
								include_once('pdfs/registro-nascimento-livro-v2.php');
							}	
							?>	
						<?php endif ?>
