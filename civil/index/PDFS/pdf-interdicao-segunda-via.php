...
$r = PESQUISA_ALL_ID('registro_interdicao_novo',$id);
	foreach ($r as $r ) :
...
include('../../selador/civil_geral.php');
      ...
      #PROXIMO PASSO ENVIANDO A SOLICITAÇÃO DO SELO: ===============================================================================================
                ...
                $insert_auditoria = $pdo->prepare("INSERT into auditoria values (NULL,'$funcionario','CERT_INTERDICAO','2','1','$SELO',CURRENT_TIMESTAMP,'CER','$ATO','$LIVRO','$FOLHA','$TERMO','$TIPOPAPEL','$NUMEROPAPEL','$RETORNO')");
...
if (isset($SELO)) {include('config_paginas/registro-interdicao-segunda-via.php');}?>
