...
header('location:../notas-lavratura-cep-escritura-cessao-posse.php?conf1=ok&id='.$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cep-escritura-cessao-posse.php?conf4=ok&id='.$id);
...
header('location:../notas-lavratura-cep-escritura-cessao-posse.php?conf3=ok&id='.$id);
