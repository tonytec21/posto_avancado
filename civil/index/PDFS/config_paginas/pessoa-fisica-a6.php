...
<tr>
	<td style="width: 30%;">&nbsp;
		...
		<?php #if (isset($key->hiddencaminhofoto) && !empty($key->hiddencaminhofoto) && $key->hiddencaminhofoto != ''): ?>
		<!-- <div style="margin-top:-15px">
		<img style="width: 50px; height: 60px;" src="../<?PHP #echo $key->hiddencaminhofoto?>"  >
		</div> -->
		<?php #endif ?>
