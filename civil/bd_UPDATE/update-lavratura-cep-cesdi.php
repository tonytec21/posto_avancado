...
if (isset($_POST['setNaturezaEscritura']) || $_POST['setNaturezaEscritura'] =! "? undefined:undefined ?") {
...
if (isset($_POST['setNaturezaLitigio']) || $_POST['setNaturezaLitigio'] =! "? undefined:undefined ?") {
...
if (isset($_POST['setResponsavelFilhos']) && $_POST['setResponsavelFilhos'] =! "? undefined:undefined ?") {
...
$setQualidadeCepParte1 = $_POST['setQualidadeCepParte1'];
}else {
	$setQualidadeCepParte1 = NULL;
}
UPDATE_CAMPO_ID('notas_lavratura','setQualidadeParte1',$_POST['setQualidadeParte1'],$id);
UPDATE_CAMPO_ID('notas_lavratura','setQualidadeCepParte1',$setQualidadeCepParte1,$id);
...
UPDATE_CAMPO_ID('notas_lavratura','dataNascimentoParte1',$dataNascimentoParte1,$id);UPDATE_CAMPO_ID('notas_lavratura','strProfissaoParte1',$_POST['strProfissaoParte1'],$id);
...
UPDATE_CAMPO_ID('notas_lavratura','dataNascimentoParte2',$dataNascimentoParte2,$id);UPDATE_CAMPO_ID('notas_lavratura','strProfissaoParte2',mb_strtoupper($_POST['strProfissaoParte2']),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strProcuradorDataParte2',$strProcuradorDataParte2,$id);UPDATE_CAMPO_ID('notas_lavratura','strProcuradorCartorioParte2',mb_strtoupper($_POST['strProcuradorCartorioParte2']),$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cesdi.php?conf4=ok&id='.$id);
