...
<?php session_start();  $id = $_GET['id'];include('header.php');
include('menu.php');?>
        ...
        <section class="content" style="margin-left: 30px"  >
              ...
              <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                           <h2 class="col-md-9">HABILITAÇÃO 1º FASE</h2>
                           <a href="pdf-casamento-autuamento?id=<?=$id?>&id_apagar=<?=$id?>" class="btn col-md-3 waves-effect bg-red "><i class="material-icons">stop_screen_share</i> Limpar edições feitas </a>
                        </div>
                        <div class="body">
...
<?php include('config_paginas/registro-casamento-autuamento.php'); ?>
...
$up = $pdo->prepare("UPDATE salvar_editor set TEXTO = '$texto_salvar' where IDREGISTRO = '$id' and TIPO = '1_HAB_CASAMENTO' ");
$up->execute();
}
else{
$in = $pdo->prepare("INSERT into salvar_editor values('$id', '1_HAB_CASAMENTO', '$texto_salvar')");
$in->execute();
}
...
$_SESSION['sucesso'] = 'ALTERAÇÕES SALVAS';
 ...
 ?>
  ...
  <script type="text/javascript">
      window.location.assign('pdf-casamento-autuamento.php?id=<?=$id?>');
