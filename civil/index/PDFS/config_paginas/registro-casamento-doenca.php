...
?> no DESCRIÇÃO DO LOCAL (alterar quando criar no form/banco) do Município de
...
?>, presente o(a). Juiz de Casamentos <?=strtoupper($r->strJuizPaz)?> ou ad hoc comigo,
...
<br>
O termo avulso, lavrado pelo oficial ad hoc, foi registrado no respectivo livro no prazo legal de cinco dias,
determinado pelo art. 1.539 do Código Civil e perante duas testemunhas, ficando arquivado.
<br>
