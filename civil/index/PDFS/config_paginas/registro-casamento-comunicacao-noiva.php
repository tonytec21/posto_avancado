...
casamento de <?=strtoupper($r->NOMENUBENTE1)?> e <?=strtoupper($r->NOMENUBENTE2)?>, registrado(a) No Livro <?=$_GET['livroa']?>, Folha <?=$_GET['folhaa']?>, Termo <?=$_GET['termoa']?>,



<?php if ($r->NOMENUBENTE2!=$r->NOMECASADONUBENTE2): ?>
	passando o(a) mesmo(a) após o casamento a chamar-se <?=strtoupper($r->NOMECASADONUBENTE2)?>, 
	<?php else: ?>
	o mesmo(a) permanecerá a usar o mesmo nome,		
<?php endif ?> filha de
<?php if ($r->NOMEPAINUBENTE2 !='' && $r->NOMEPAINUBENTE2!=='NAO_DECLARADO'): ?>
<?=strtoupper($r->NOMEPAINUBENTE2)?> e 
<?php endif ?>
<?=strtoupper($r->NOMEMAENUBENTE2)?>.
