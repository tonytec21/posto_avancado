...
include('../../selador/civil_geral.php');
      ...
      #PROXIMO PASSO ENVIANDO A SOLICITAÇÃO DO SELO: ===============================================================================================
                ...
                $insert_auditoria = $pdo->prepare("INSERT into auditoria values (NULL,'$funcionario','CERT_POSITIVA','2','1','$SELO',CURRENT_TIMESTAMP,'CER','$ATO','$LIVRO','$FOLHA','$TERMO','$TIPOPAPEL','$NUMEROPAPEL','$RETORNO')");
                ...
                $insert_auditoria->execute();
                 ...
                 if (isset($_GET['selobusca']) && $_GET['selobusca']!='') {
                            ...
                            $NUMEROPAPEL = $_GET['NUMEROPAPELSEGURANCA'];  
                            $funcionario = $_SESSION['nome'];
                            $insert_auditoria = $pdo->prepare("INSERT into auditoria values (NULL,'$funcionario','BUSCA_CERT_POSITIVA','2','1','$SELOBUSCA',CURRENT_TIMESTAMP,'CER','$ATO','$LIVRO','$FOLHA','$TERMO','$TIPOPAPEL','$NUMEROPAPEL','$RETORNOBUSCA')");
                            $UPSEGURANCA = $pdo->prepare("UPDATE folhaseguranca set STATUS = 'U' WHERE EMPRESA = '$TIPOPAPEL' AND PAPEL = '$NUMEROPAPEL'");
                            $UPSEGURANCA->execute();  
...
$busca_ja_existe = $pdo->prepare("SELECT * FROM salvar_editor where IDREGISTRO = '$id' and TIPO = 'CERT_POSITIVA'");
 ...
 if (isset($SELO)) { include('config_paginas/registro-nascimento-certidao-positiva.php');}} ?>
</textarea>
...
$id_slv = '0000';
$tipo_slv = 'CERT_POSITIVA_'.str_replace(".png", "", str_replace(" ", "_", $img_nome));
$texto_salvar = '<html>
<head>
...
<!--TINYMCE EDITADO -->   <input name="image" type="file" id="upload" class="hidden" onchange="">
