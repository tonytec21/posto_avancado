...
$upLivro = $pdo->prepare("UPDATE livro_outros set Status = 'U' where PaginaLivro = '$folha'");
$upLivro->execute();
...
if (empty($_POST['setConjungue'])) {
	$_POST['setConjungue'] = 'N';
	$_POST['strConjungue'] = '';
}


if (empty($_POST['setSeloGratuito2'])) {
	$_POST['setSeloGratuito2'] = 'N';
	$_POST['strJustificativa2'] = '';
}
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura.php.php?confn=ok&id='.$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura.php.php?confa=ok&id='.$id);
...
var_dump($_POST);
header('location:../notas-lavratura.php.php?id='.$id);
