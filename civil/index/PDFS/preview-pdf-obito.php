...
<?php include('config_paginas/preview-obito.php'); ?>
...
if (isset($_POST['textoregistro'])) {
 ...
 $pdo = conectar();
$in_virtual = $pdo->prepare("UPDATE livro_obitos set assento = '$texto' where identifcadorLivro = '$r->LIVROOBITO' and PaginaLivro = '$r->FOLHAOBITO' ");
$in_virtual->execute();
}
