...
<!--CABEÇAÇHO ------------------------------------------------------------------------------------------------>
			...
			<h3 style="display: inline;margin-left: 1cm">LIVRO: E <?=intval($r->LIVROCASAMENTO)?></h3>
			<?php else: ?>		
			<h3 style="display: inline;margin-left: 1cm">LIVRO: B <?=intval($r->LIVROCASAMENTO)?></h3>
			<?php endif ?>	
			...
			?> (<?=date('d/m/Y', strtotime($r->DATACASAMENTO))?>), neste(a)
		...
		<!--TEXTO DO CASAMENTO ----------------------------------------------------------------------------------------------->
							...
							achado conforme, vai devidamente assinado pelo Juiz de Paz, contraentes e testemunhas. Eu,
...
<div style="position: absolute;width: 50%; margin-top: -120px;">
...
return preg_replace(array("/(á|à|ã|â|ä)/","/(Á|À|Ã|Â|Ä)/","/(é|è|ê|ë)/","/(É|È|Ê|Ë)/","/(í|ì|î|ï)/","/(Í|Ì|Î|Ï)/","/(ó|ò|õ|ô|ö)/","/(Ó|Ò|Õ|Ô|Ö)/","/(ú|ù|û|ü)/","/(Ú|Ù|Û|Ü)/","/(ñ)/","/(Ñ)/","/(Ç)/","/(ç)/"),explode(" ","a A e E i I o O u U n N C c"),$string);
	...
	<!--p style="font-weight: bold; font-size: 6px;margin-top: -10px;width: 30%;"><?=$textoselo?></p-->
	</div>
