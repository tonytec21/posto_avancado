...
header('location:../notas-lavratura-cep-escritura-uniao-estavel.php?conf1=ok&id='.$id);
...
$numAto = $_SESSION['numero_ordem_ato'];
...
$pesquisa_num_ordem->execute();
$$_SESSION['numero_ordem_ato_cesdi'] = $pesquisa_num_ordem->rowCount() + 1;
UPDATE_CAMPO_ID('notas_lavratura','Ordem',$_SESSION['numero_ordem_ato_cesdi'],$id);
UPDATE_CAMPO_ID('notas_lavratura','numAto',$_SESSION['numero_ordem_ato_cesdi'],$id);
...
if (isset($_POST['strObservacoesGerais'])) {
$strObservacoesGerais = $_POST['strObservacoesGerais'];
}else {
	$strObservacoesGerais = NULL;

}
if (isset($_POST['dataEscrituraUniaoEstavel'])) {
$dataEscrituraUniaoEstavel = $_POST['dataEscrituraUniaoEstavel'];
}else {
	$dataEscrituraUniaoEstavel = '1111-11-11';

}
$dataEscrituraUniaoEstavel= date('Y/m/d', strtotime($dataEscrituraUniaoEstavel));
...
UPDATE_CAMPO_ID('notas_lavratura','strObservacoesGerais',mb_strtoupper($strObservacoesGerais),$id);
UPDATE_CAMPO_ID('notas_lavratura','dataEscrituraUniaoEstavel',$dataEscrituraUniaoEstavel,$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cep-escritura-uniao-estavel.php?conf4=ok&id='.$id);
...
header('location:../notas-lavratura-cep-escritura-uniao-estavel.php?conf3=ok&id='.$id);
