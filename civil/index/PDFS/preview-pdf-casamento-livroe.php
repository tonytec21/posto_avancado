<!DOCTYPE html>
<?php session_start();header("Cache-Control: no-cache, must-revalidate"); // HTTP/1.1 ?>
<html>

<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <title>Registro de Casamento</title>
...
<?php include('config_paginas/preview-casamento-livroe.php'); ?>
...
if (isset($_POST['textoregistro'])) {
 ...
 $pdo = conectar();
$in_virtual = $pdo->prepare("UPDATE livro_casamentos set assento = '$texto' where identifcadorLivro = '$r->LIVROCASAMENTO' and PaginaLivro = '$r->FOLHACASAMENTO' ");
$in_virtual->execute();
}
