...
$r = PESQUISA_ALL_ID('registro_livro_e',$id);
	foreach ($r as $r ) :
...
include('../../selador/civil_geral.php');
      ...
      #PROXIMO PASSO ENVIANDO A SOLICITAÇÃO DO SELO: ===============================================================================================
                ...
                $LIVRO = $r->LIVRO;
                $FOLHA = $r->FOLHA;
                $TERMO = intval($r->TERMO);
                $ATO = '14.5.1';
                $TIPOPAPEL = $_GET['TIPOPAPELSEGURANCA'];
                $NUMEROPAPEL = $_GET['NUMEROPAPELSEGURANCA'];  
                $funcionario = $_SESSION['nome'];
                $insert_auditoria = $pdo->prepare("INSERT into auditoria values (NULL,'$funcionario','CERT_LIVROE','2','1','$SELO',CURRENT_TIMESTAMP,'CER','$ATO','$LIVRO','$FOLHA','$TERMO','$TIPOPAPEL','$NUMEROPAPEL','$RETORNO')");
...
if (isset($SELO)) {include('config_paginas/registro-livrogeral-segunda-via.php');}?>
