...
<div class="modal fade" id="pessoas" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-lg" role="document">
                  ...
                  <button type="button" class="btn btn-link bg-red waves-effect" data-dismiss="modal">X</button>
                        ...
                        <div id="pessoascas" class="modal-body">
           <script>
...
function showCustomer() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      $('#pessoascas').html (this.responseText);
    return;
    }
    else{
      $('#pessoascas').html ("<h4 class='text-center'>Carregando... <br> <img src='../../images/loading_modal.gif'> </h4>"); 
       return;
    }
