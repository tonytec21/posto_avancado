...
body{ font-size: 14px;font-family: "Arial";background: url("../../../images/preview.jpg");}
</style>
</head>
...
Certifico que no livro E-<?=$r->LIVROESPECIAL?>, folha <?=$r->FOLHAESPECIAL?> e registro <?=$r->TERMOESPECIAL?>, de Registro de Emancipação, Interdição e Ausência, deste Ofício, consta que foi lavrado aos 	
					...
					<?php endif ?>
													...
													registrado neste Ofício no Livro de nº <?=$r->LIVROREGISTRONASCIMENTO?>, Folha <?=$r->FOLHAREGISTRONASCIMENTO?>,  Conforme sentença expedida pelo(a) Exmo(a). Juiz(a) <?=$r->JUIZ?>, <?=$r->VARA?> em <?=date('d/m/Y',strtotime($r->DATASENTENCA))?>,
