...
body{ font-size: 12px;font-family: "Arial";margin-left: 2cm;margin-bottom: -10cm;}
</style>
</head>
...
foreach ($r as $r ) :
if (isset($_GET['preview']) && $r->DATAENTRADA == '') {
...
<hr style="border:1px solid black">
			<h3 style="display: inline;margin-left: 0cm">LIVRO: B - AUXILIAR <?=intval($r->LIVROCASAMENTO)?></h3>
