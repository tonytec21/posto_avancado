...
<body>
<?php $b = PESQUISA_ALL_CAMPO('livro_casamentos','identifcadorLivro', $livro);?>
...
<div style="padding-top: 1%;font-size: 70%">
<img style="width: 100%;height: 3cm; margin-top: 10px;" src="../bd_INSERTS/<?=$img?>">
<?=str_replace($mudar, "", $b->assento)?>
</div>
</div>	
<p style=" text-align: right;position: fixed;  "><?=$b->PaginaLivro?></p>	
