...
header('location:../notas-lavratura-cep-escritura-reconhecimento.php?conf1=ok&id='.$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strNomeParte3',mb_strtoupper($_POST['strNomeParte3']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strFilhoNovoNome',$_POST['strFilhoNovoNome'],$id);
UPDATE_CAMPO_ID('notas_lavratura','setAssinaParte3',$_POST['setAssinaParte3'],$id);
UPDATE_CAMPO_ID('notas_lavratura','strNomeAvo1',$_POST['strNomeAvo1'],$id);
UPDATE_CAMPO_ID('notas_lavratura','strNomeAvo2',$_POST['strNomeAvo2'],$id);
UPDATE_CAMPO_ID('notas_lavratura','strFilhoObservacao',$_POST['strFilhoObservacao'],$id);

UPDATE_CAMPO_ID('notas_lavratura','setSexoParte3',mb_strtoupper($_POST['setSexoParte3']),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strProfissaoParte3',mb_strtoupper($_POST['strProfissaoParte3']),$id);
UPDATE_CAMPO_ID('notas_lavratura','setEstadoCivilParte3',mb_strtoupper($_POST['setEstadoCivilParte3']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strRogoParte3',mb_strtoupper($_POST['strRogoParte3']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strMotivoParte3',mb_strtoupper($_POST['strMotivoParte3']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strProcuradorParte3',mb_strtoupper($_POST['strProcuradorParte3']),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strCidadeParte3',(int)$_POST['strCidadeParte3'],$id);
UPDATE_CAMPO_ID('notas_lavratura','strLogradouroParte3',mb_strtoupper($_POST['strLogradouroParte3']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strBairroParte3',mb_strtoupper($_POST['strBairroParte3']),$id);

//fechar parte 3
//parte 4

UPDATE_CAMPO_ID('notas_lavratura','setQualidadeCepParte4',$_POST['setQualidadeCepParte4'],$id);
UPDATE_CAMPO_ID('notas_lavratura','strNomeParte4',mb_strtoupper($_POST['strNomeParte4']),$id);
UPDATE_CAMPO_ID('notas_lavratura','setAssinaParte4',mb_strtoupper($_POST['setAssinaParte4']),$id);
UPDATE_CAMPO_ID('notas_lavratura','setSexoParte4',mb_strtoupper($_POST['setSexoParte4']),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strProfissaoParte4',mb_strtoupper($_POST['strProfissaoParte4']),$id);
UPDATE_CAMPO_ID('notas_lavratura','setEstadoCivilParte4',mb_strtoupper($_POST['setEstadoCivilParte4']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strRogoParte4',mb_strtoupper($_POST['strRogoParte4']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strMotivoParte4',mb_strtoupper($_POST['strMotivoParte4']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strProcuradorParte4',mb_strtoupper($_POST['strProcuradorParte4']),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strCidadeParte4',(int)$_POST['strCidadeParte4'],$id);
UPDATE_CAMPO_ID('notas_lavratura','strLogradouroParte4',mb_strtoupper($_POST['strLogradouroParte4']),$id);
UPDATE_CAMPO_ID('notas_lavratura','strBairroParte4',mb_strtoupper($_POST['strBairroParte4']),$id);
//fechar parte 4
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cep-escritura-reconhecimento.php?conf4=ok&id='.$id);
...
header('location:../notas-lavratura-cep-escritura-reconhecimento.php?conf3=ok&id='.$id);
