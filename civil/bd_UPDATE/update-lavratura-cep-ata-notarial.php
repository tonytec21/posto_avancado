...
header('location:../notas-lavratura-cep-ata-notarial.php?conf1=ok&id='.$id);
...
UPDATE_CAMPO_ID('notas_lavratura','setTipodeAtoCep',8,$id);
UPDATE_CAMPO_ID('notas_lavratura','setNaturezaEscritura',$setNaturezaEscritura,$id);
UPDATE_CAMPO_ID('notas_lavratura','setNaturezaLitigio',$setNaturezaLitigio,$id);
UPDATE_CAMPO_ID('notas_lavratura','strAcordo',$strAcordo,$id);
UPDATE_CAMPO_ID('notas_lavratura','strInfoAdicionais',mb_strtoupper($strInfoAdicionais),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','strAtoDesconhecido',$strAtoDesconhecido,$id);
UPDATE_CAMPO_ID('notas_lavratura','strLivroOutro',$strLivroOutro,$id);
UPDATE_CAMPO_ID('notas_lavratura','strLivroComplementoOutro',$strLivroComplementoOutro,$id);
UPDATE_CAMPO_ID('notas_lavratura','strFolhaOutro',$strFolhaOutro,$id);
UPDATE_CAMPO_ID('notas_lavratura','strFolhaComplementoOutro',$strFolhaComplementoOutro,$id);
UPDATE_CAMPO_ID('notas_lavratura','strEstadoOutro',$strEstadoOutro,$id);
UPDATE_CAMPO_ID('notas_lavratura','strCidadeOutro',$strCidadeOutro,$id);
UPDATE_CAMPO_ID('notas_lavratura','strNomeCartorioOutro',mb_strtoupper($strNomeCartorioOutro),$id);
...
UPDATE_CAMPO_ID('notas_lavratura','setRegimeBens',$setRegimeBens,$id);
UPDATE_CAMPO_ID('notas_lavratura','checkboxPossuiFilhos',$checkboxPossuiFilhos,$id);
UPDATE_CAMPO_ID('notas_lavratura','strFilhosMaiores',$strFilhosMaiores,$id);
UPDATE_CAMPO_ID('notas_lavratura','strFilhosMenores',$strFilhosMenores,$id);
UPDATE_CAMPO_ID('notas_lavratura','setResponsavelFilhos',$setResponsavelFilhos,$id);
UPDATE_CAMPO_ID('notas_lavratura','qtdFilhosMaiores',$qtdFilhosMaiores,$id);
UPDATE_CAMPO_ID('notas_lavratura','qtdFilhosMenores',$qtdFilhosMenores,$id);


UPDATE_CAMPO_ID('notas_lavratura','setQualidadeCepParte1',$_POST['setQualidadeCepParte1'],$id);
UPDATE_CAMPO_ID('notas_lavratura','strNomeParte1',mb_strtoupper($_POST['strNomeParte1']),$id);
...
$dataNascimentoParte3 = $_POST['dataNascimentoParte3'];
	...
	$dataNascimentoParte3 = '1111-11-11';
...
$dataNascimentoParte4 = $_POST['dataNascimentoParte4'];
	...
	$dataNascimentoParte4 = '1111-11-11';
...
if (isset($_POST['intImovelindicadorArea'])) {
...
UPDATE_CAMPO_ID('notas_lavratura','strImovelMatricula',$strImovelMatricula,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelTipoTransacao',$intImovelTipoTransacao,$id);
UPDATE_CAMPO_ID('notas_lavratura','strInfoImovel',$strInfoImovel,$id);
UPDATE_CAMPO_ID('notas_lavratura','dataInfoImovel',$dataInfoImovel,$id);
UPDATE_CAMPO_ID('notas_lavratura','strInfoImovelCertidao  ',$strInfoImovelCertidao  ,$id);
UPDATE_CAMPO_ID('notas_lavratura','decValorInfoImovel',$decValorInfoImovel,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelSituacao',$intImovelSituacao,$id);
UPDATE_CAMPO_ID('notas_lavratura','strImovelDescTransacao',$strImovelDescTransacao,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelRetificacao',$intImovelRetificacao,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelformaAlienacao',$intImovelformaAlienacao,$id);
UPDATE_CAMPO_ID('notas_lavratura','intValorNaoConsta',$intValorNaoConsta,$id);
UPDATE_CAMPO_ID('notas_lavratura','decImovelcalcITBI',$decImovelcalcITBI,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelTipo',$intImovelTipo,$id);
UPDATE_CAMPO_ID('notas_lavratura','strImovelDesc',$strImovelDesc,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelConstrucao',$intImovelConstrucao,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelLocalidade',$intImovelLocalidade,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelindicadorArea',$intImovelindicadorArea,$id);
UPDATE_CAMPO_ID('notas_lavratura','decImovelArea',$decImovelArea,$id);
UPDATE_CAMPO_ID('notas_lavratura','strImovelEndereco',$strImovelEndereco,$id);
UPDATE_CAMPO_ID('notas_lavratura','strImovelNumero',$strImovelNumero,$id);
UPDATE_CAMPO_ID('notas_lavratura','strImovelComplemento',$strImovelComplemento,$id);
UPDATE_CAMPO_ID('notas_lavratura','strCidadeInfoImovel',$strCidadeInfoImovel,$id);

UPDATE_CAMPO_ID('notas_lavratura','strImovelBairro',$strImovelBairro,$id);
UPDATE_CAMPO_ID('notas_lavratura','strImovelUF',$strImovelUF,$id);
UPDATE_CAMPO_ID('notas_lavratura','intImovelCep',$intImovelCep,$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cep-ata-notarial.php?conf4=ok&id='.$id);
...
$insert_auditoria = $pdo->prepare("INSERT into auditoria values (NULL,'$funcionario','ATA NOTARIAL','1','1','$seloExplode[$i]',CURRENT_TIMESTAMP,'$tipoSelo','$desTipoAto[$i]','$numLivro','$numFolha','$numOrdem','0','0','0')");
...
$pesquisa_livro = $pdo->prepare("SELECT * FROM livro_notas_ata_notarial where status = 'L' limit 1");
...
$pesquisa_livro_notas = $pdo->prepare("SELECT strLivro,strFolha,strFolhaFinal,strFolhaComplemento,setTipodeAtoCep,strSelo,quantidadeFolhas FROM `notas_lavratura` WHERE strFolha > 0 and setTipodeAtoCep = '8' and strLivro = '$livro'  and (strSelo IS NOT NULL || strSelo != '') ORDER BY `notas_lavratura`.`strFolha` DESC LIMIT 1 ");
...
#Quando for cep:
$pesquisa_num_ordem = $pdo->prepare("SELECT strSelo,strFolha,strFolhaFinal,strFolhaComplemento,setTipodeAtoCep,Ordem, COUNT(Ordem) AS Quantidade FROM `notas_lavratura` WHERE strFolha > 0 and setTipodeAtoCep = '8' and (strSelo IS NOT NULL || strSelo != '') ORDER BY `notas_lavratura`.`strFolha`");
...
//
// $pesquisa_num_ato = $pdo->prepare("SELECT strSelo,strFolha,strFolhaFinal,strFolhaComplemento,setTipodeAtoCep,numAto, COUNT(numAto) AS Quantidade FROM `notas_lavratura` WHERE strFolha > 0 and setTipodeAtoCep = '8' and (strSelo IS NOT NULL || strSelo != '') ORDER BY `notas_lavratura`.`strFolha`");
...
UPDATE_CAMPO_ID('notas_lavratura','numAto',$numOrdem,$id);
...
header('location:../notas-lavratura-cep-ata-notarial.php?conf3=ok&id='.$id);
