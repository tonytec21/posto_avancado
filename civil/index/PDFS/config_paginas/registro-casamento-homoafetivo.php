...
if ($r->setSexoNoivo != $r->setSexoNoiva) {
echo '<span style="color:white; background:red"> NUBENTES NÃO SÃO DO MESMO SEXO!</span>';
	$_SESSION['erro'] = 'NUBENTES NÃO SÃO DO MESMO SEXO!';
	break;
}
...
?> neste Cartório, Subdistrito Civil __________ Comarca do Município de
...
?>, presente o(a). Juiz de Casamentos <?=strtoupper($r->strJuizPaz)?> comigo,
<?=strtoupper($r->strEscrivao)?> ao final nomeado e assinado, e na presença das testemunhas:
...
<?=$r->strPaiNoivo?>, <?=$r->strProfissaoPaiNoivo?>
 e de <?php endif ?>
 <?=$r->strMaeNoivo?>, <?=$r->strProfissaoMaeNoivo?>.
<br>
...
<?=$r->strPaiNoiva?>, <?=$r->strProfissaoPaiNoiva?>
e de <?php endif ?> <?=$r->strMaeNoiva?>, <?=$r->strProfissaoMaeNoiva?>.
...
<br>
O processo de habilitação deixou de obter a manifestação do Ministério Público em decorrência do Ato Normativo nº 680/2011 - PGJ/CGMP/CPJ de 07/02/2011. <br>


Os editais de proclamas foram afixados em cartório durante o prazo de lei, a partir do dia
...
<?php
$data = $r->dataProclamas;
$novaDataProclamas = explode("-", $data);
#echo $novaDataProclamas[2]." de ";

if ($novaDataProclamas[2] == '01' || $novaDataProclamas[2] == '1') {
	echo " Um de  ";
}elseif ($novaDataProclamas[2] == '02' || $novaDataProclamas[2] == '2') {
	echo " Dois de ";
} elseif ($novaDataProclamas[2] == '03' || $novaDataProclamas[2] == '3') {
	echo " Três ";
} elseif ($novaDataProclamas[2] == '04' || $novaDataProclamas[2] == '4') {
	echo " Quatro de ";
} elseif ($novaDataProclamas[2] == '05' || $novaDataProclamas[2] == '5') {
	echo " Cinco de ";
} elseif ($novaDataProclamas[2] == '06' || $novaDataProclamas[2] == '6') {
	echo " Seis de ";
} elseif ($novaDataProclamas[2] == '07' || $novaDataProclamas[2] == '7') {
	echo " Sete de ";
} elseif ($novaDataProclamas[2] == '08' || $novaDataProclamas[2] == '8') {
	echo " Oito de ";
} elseif ($novaDataProclamas[2] == '09' || $novaDataProclamas[2] == '9') {
	echo " Nove de ";
} else {echo  ucfirst(GExtenso::numero($novaDataProclamas[2]));}
//Será exibido na tela a data: 16/02/2015
// . "de".$novaDataProclamas[1] . " de " . GExtenso::numero ($novaDataProclamas[0])

if ($novaDataProclamas[1] == '01' || $novaDataProclamas[1] == '1') {
	echo " de Janeiro de ";
}elseif ($novaDataProclamas[1] == '02' || $novaDataProclamas[1] == '2') {
	echo " de Fevereiro de ";
} elseif ($novaDataProclamas[1] == '03' || $novaDataProclamas[1] == '3') {
	echo " de Março de ";
} elseif ($novaDataProclamas[1] == '04' || $novaDataProclamas[1] == '4') {
	echo " de Abril de ";
} elseif ($novaDataProclamas[1] == '05' || $novaDataProclamas[1] == '5') {
	echo " de Maio de ";
} elseif ($novaDataProclamas[1] == '06' || $novaDataProclamas[1] == '6') {
	echo " de Junho de ";
} elseif ($novaDataProclamas[1] == '07' || $novaDataProclamas[1] == '7') {
	echo " de Julho de ";
} elseif ($novaDataProclamas[1] == '08' || $novaDataProclamas[1] == '8') {
	echo " de Agosto de ";
} elseif ($novaDataProclamas[1] == '09' || $novaDataProclamas[1] == '9') {
	echo " de Setembro de ";
} elseif ($novaDataProclamas[1] == '10') {
	echo " de Outubro de";
} elseif ($novaDataProclamas[1] == '11') {
	echo " de Novembro de ";
} elseif ($novaDataProclamas[1] == '12') {
	echo " de Dezembro de ";
} else {
	echo "Não definido";
}

echo $novaDataProclamas[0];

?>
  (<?=date ('d/m/Y', strtotime($r->dataEdital))?>), sendo feita a publicação pelo Jornal Diário de Notícias.
	<br>
Do que lavrei este termo que lido, e achado conforme, vai devidamente assinado pelo(a) MM(ª). Juiz de Casamentos, os contraentes
e as testemunhas retro qualificadas.
<br>
