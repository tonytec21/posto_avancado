...
<head>
    ...
    <title>CERTIDÕES DE CANCELAMENTO</title>
...
<body class="theme-red">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            ...
            <?php if (isset($token)): ?>
              <p>O(s) Selo(s) Estão sendo solicitado(s), Aguarde</p>
            <?php else: ?>
              <p>Carregando...</p>
            <?php endif ?>
        </div>
        ...
        <section class="content" style="margin-left: 30px"  >
              ...
              <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                           <h2>NOTIFICAÇÃO(S) DE PROTESTO</h2>
...
<?php include('config_paginas/protesto-certidao-cancelamento.php'); ?>
