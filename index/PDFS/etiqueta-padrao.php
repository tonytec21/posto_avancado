...
<?=corrigirACENTO_utf8($textoselo)?>
		<?php //echo mb_strtoupper($ASSINATURA).'<br>Em Test. ______________ da verdade.';?> 
  </span>
</p>

<span style="position:absolute;margin-top:-60%">

<img style='position:absolute;;z-index: 1;margin-right:-30%;padding-top: <?=$r->VERTICAL_QR_CODE?>;margin-top:<?=$r->VERTICAL_QR_CODE?>%;'  alt="Qr Code" width="32%" align="right" src="data:image/png;base64,<?=$nome?>"  /> </img>
</span>
