...
if (isset($SELO)) {include('config_paginas/registro-casamento-materializacao.php');}?>
...
$id_slv = '0000';
$tipo_slv = 'CERTIDAO_MATERIALIZADA_CRC_'.str_replace(".png", "", str_replace(" ", "", $parte_exp));
$texto_salvar = '<html>
<head>
