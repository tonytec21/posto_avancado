...
body{font-family: "Arial";margin-left: 1cm;margin-right:1cm;margin-bottom: -10cm;text-transform: uppercase; }
</style>
</head>
...
<div style="position: absolute;width: 50px; margin-left: -10px;width: 200px;margin-top: -50px;"> 
<?php
