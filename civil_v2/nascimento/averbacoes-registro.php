...
<body class="index-page bg-secondary main_dark_mode" style="max-width:100%">
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-12">
								...
								salvar_av( 
									...
									'<?=$dados["LIVRONASCIMENTO"]?>',
									'<?=$dados["FOLHANASCIMENTO"]?>',
									'<?=$dados["TERMONASCIMENTO"]?>',
									'<?=$dados["ID"]?>',
									'<?=$dados["NOMENASCIDO"]?>',
									'NA',
									'<?=date('Y-m-d')?>'
	...
	<script type="text/javascript">
		$(document).ready(function(){
			atualizaraverbacoes('<?=$dados["LIVRONASCIMENTO"]?>', '<?=$dados["FOLHANASCIMENTO"]?>', "NA", '<?=addslashes($dados["NOMENASCIDO"])?>');
		});
	</script>
