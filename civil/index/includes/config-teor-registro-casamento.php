...
function idade_civil_antigo($nascimento,$dataregistro){
   if (empty($nascimento) || !isset($nascimento)) {
  	$nascimento = date('Y-m-d');
  }
  if (empty($dataregistro) || !isset($dataregistro)) {
...
<?php if ($r->TIPOLIVRO == '2' || empty($r->TIPOLIVRO) || $r->TIPOLIVRO == '7'): 

					if (empty($r->DATAENTRADA)) {
						$data_registro = date('Y-m-d');
						}
						else{
						$data_registro = $r->DATAENTRADA;
						}	
						...
						?>
							...
							<!--NUBENTE1 -------------------------------------------------------------------------------------------------------->	
								<p style="text-align: justify;">O(a) Conjuge 
										...
										<?=idade_civil_antigo($r->DATANASCIMENTONUBENTE1,$data_registro)?> anos de idade, 
										<?php endif ?>
										<?php endif ?>
										...
										<?php if ($r->DATANASCIMENTOMAENUBENTE1!=''): ?>
											Com 
										<?=idade_civil_antigo($r->DATANASCIMENTOMAENUBENTE1,$data_registro)?> anos de idade. 
										<?php endif ?>
										<?php endif ?>
								 </p>
							<!--NUBENTE1 -------------------------------------------------------------------------------------------------------->
							...
							<!--NUBENTE2 -------------------------------------------------------------------------------------------------------->	
								<p style="text-align: justify;">O(a) Conjuge 
										...
										<?=idade_civil_antigo($r->DATANASCIMENTONUBENTE2,$data_registro)?> anos de idade
										<?php endif ?>
										<?php endif ?>
										...
										?>, Com 
										<?=idade_civil_antigo($r->DATANASCIMENTOPAINUBENTE2,$data_registro)?> anos de idade, 
										<?php endif ?>
										E de 
										<?php endif ?>		
										...
										<?php if ($r->DATANASCIMENTOMAENUBENTE2!=''): ?>
											Com 
										<?=idade_civil_antigo($r->DATANASCIMENTOMAENUBENTE2,$data_registro)?> anos de idade. 
										<?php endif ?>
										<?php endif ?>
								 </p>
							<!--NUBENTE2 -------------------------------------------------------------------------------------------------------->
							<!--TESTEMUNHAS ------------------------------------------------------------------------------------------------------>
									...
									Com 
									<?=idade_civil_antigo($r->DATANASCIMENTOTESTEMUNHA1,$data_registro)?> anos de idade.
									<?php endif ?>
									<?php endif ?>
									...
									Com 
									<?=idade_civil_antigo($r->DATANASCIMENTOTESTEMUNHA2,$data_registro)?> anos de idade.
									<?php endif ?>
									<?php endif ?>
									...
									Com 
									<?=idade_civil_antigo($r->DATANASCIMENTOTESTEMUNHA3,$data_registro)?> anos de idade.
									<?php endif ?>
									<?php endif ?>
									...
									Com 
									<?=idade_civil_antigo($r->DATANASCIMENTOTESTEMUNHA4,$data_registro)?> anos de idade.
									<?php endif ?>
									<?php endif ?>
									...
									Com 
									<?=idade_civil_antigo($r->DATANASCIMENTOTESTEMUNHA5,$data_registro)?> anos de idade.
									<?php endif ?>
									<?php endif ?>
									...
									Com 
									<?=idade_civil_antigo($r->DATANASCIMENTOTESTEMUNHA6,$data_registro)?> anos de idade.
									<?php endif ?>
									<?php endif ?>
							...
							<!--TEXTO DO CASAMENTO ----------------------------------------------------------------------------------------------->
												...
												<?php endif ?>
												 ...
												 Eu,
												<?=mb_strtoupper($_SESSION['nome'])?>, <?=mb_strtoupper($_SESSION['funcao'])?> dou fé e assino ______________________________________. 	 
...
<?php elseif(!empty($r->DATARELIGIOSO)): ?>
			<?php 
			if (empty($r->DATAENTRADA)) {
						$data_registro = date('Y-m-d');
						}
		...
		O casamento foi celebrado de acordo com a Lei 1.110 de 23 de maio de 1950, com alterações
					...
					conforme, Eu, <?=$_SESSION['nome']?>, <?=$_SESSION['funcao']?> dou fé e assino. Selo de Fiscalização: <?=strip_tags($r->SELO)?>. 
