$strCidadeParte4 = (int)$_POST['strCidadeParte4'];<?php
...
header('location:../notas-lavratura-cep-escritura-rerratificacao.php?conf1=ok&id='.$id);
...
if (isset($_POST['decValorAnteriorImovel'])) {
$decValorAnteriorImovel = $_POST['decValorAnteriorImovel'];
}else {
	$decValorAnteriorImovel = NULL;
...
UPDATE_CAMPO_ID('notas_lavratura','decValorAnteriorImovel',$decValorAnteriorImovel,$id);
...
$_SESSION['sucesso'] = 'SUCESSO CONTINUE O PREENCHIMENTO DO FORMULÁRIO';
header('location:../notas-lavratura-cep-escritura-rerratificacao.php?conf4=ok&id='.$id);
...
header('location:../notas-lavratura-cep-escritura-rerratificacao.php?conf3=ok&id='.$id);
