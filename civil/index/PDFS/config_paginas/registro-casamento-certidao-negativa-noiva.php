...
<!--?=$s->strTituloServentia?--> 


Oficial do Registro Civil deste Registro
...
figurar registro em nome de <?=strtoupper($r->strNomeNoiva)?>, <?=strtoupper($r->strCPFNoiva)?>.<br>
...
<?php $h = PESQUISA_ALL('cadastroserventia');foreach ($h as $h):?><?=$h->strTituloServentia?><?php endforeach ?>
</p>
