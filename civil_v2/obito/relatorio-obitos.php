...
function notify(classe,mensagem, titulo ){
  ...
  if (LIVROOBITO == '' && DATAINICIAL == '' &&	DATAFINAL == '') 
  {
    ...
    xhttp.open("POST", "control/busca-relatorio-obito.php?LIVROOBITO="+LIVROOBITO+"&DATAINICIAL="+DATAINICIAL+"&DATAFINAL="+DATAFINAL, true);
    xhttp.send();
