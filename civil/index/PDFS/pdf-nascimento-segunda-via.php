...
<div class="row clearfix">
<div class="col-sm-12">	
<form action="" id="formsalva" method="POST" enctype="multipart/form-data">
<textarea name="textoregistro" id="" rows="30">
	
<?php 
 if (isset($_GET['CERTPORTATIL'])){
if (isset($SELO)) {include('config_paginas/registro-nascimento-certidao-portatil.php');}
 }
 else{
if (isset($SELO)) {include('config_paginas/registro-nascimento-segunda-via.php');}}?>
...
<br> <br>
<a  class=" col-md-12 btn waves-effect bg-orange" href="../../bd_INSERTS/gerador-certidao-xml-nascimento.php?id=<?=$id?>&CODIGOPEDIDOXML=<?=$_GET['CODIGOPEDIDOXML']?>">GERAR ARQUIVO XML</a>
