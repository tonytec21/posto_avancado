        ...
        <section class="content" style="margin-left: 30px"  >
              ...
              <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                           <h2 class="col-md-9">REGISTRO LIVRO E - EMANCIPAÇÃO</h2>
                           <a href="pdf-emancipacao-livroe.php?id=<?=$id?>&id_apagar=<?=$id?>" class="btn col-md-3 waves-effect bg-red "><i class="material-icons">stop_screen_share</i> Limpar edições feitas </a>
...
<?php include('config_paginas/registro-emancipacao-livroe.php'); ?>
...
$up = $pdo->prepare("update salvar_editor set TEXTO = '$texto_salvar' where IDREGISTRO = '$id' and TIPO = 'LIVROE_EMANCIPACAO' ");
$up->execute();
}
else{
$in = $pdo->prepare("INSERT into salvar_editor values('$id', 'LIVROE_EMANCIPACAO', '$texto_salvar')");
$in->execute();
}
...
$_SESSION['sucesso'] = 'ALTERAÇÕES SALVAS';
 ...
 ?>
   ...
   <script type="text/javascript">
    window.location.assign('pdf-emancipacao-livroe.php?id=<?=$id?>');
