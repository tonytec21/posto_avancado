...
<tr style="border:none;">
  <td style="border:1px solid black; padding: 10px;text-align: center;background: silver">COD. IRREGULARIDADE</td>
  <td style="border:1px solid black; padding: 10px;text-align: center;background: silver">DATA DEVOLUÇÃO</td>
...
<?php 
$k = $pdo->prepare("SELECT * FROM protesto_automatico_transacao where status = 'RECUSADO'");
$k->execute();
$b = $k->fetchAll(PDO::FETCH_OBJ);
foreach ($b as $b):

 ?>

<tr style="border:none;">
  <td style="border:1px solid black; padding: 10px;"><?=$b->codigo_irregularidade_transacao?></td>
  <td style="border:1px solid black; padding: 10px;"><?=$b->data_ocorrencia_transacao?></td>
...
?>
  ...
  <td style="border:1px solid black; padding: 10px;"><?=number_format(floatval($b->valor_titulo_transacao),2,",",".")?></td>
