...
<?php if ($pesquisa!='' && !empty($pesquisa)): ?>
          ...
          if (campo!='ROGOPAI' && campo!='ROGOMAE' && campo!='ROGOPAISOCIO' && campo!='ROGOMAESOCIO' && campo!='ROGODECLARANTE' && campo!='PROCURADORPAI' && campo != 'PAISOCIO' && campo != 'MAESOCIO') {
          $('#CPF'+campo).val(cod);
          $('#NOME'+campo).val(nome);
          $('#RG'+campo).val(rg);
          $('#SEXO'+campo).val(sexo);
          ...
          else if (campo == 'PAISOCIO' || campo == 'MAESOCIO' || campo == 'ROGOPAISOCIO' || campo == 'ROGOMAESOCIO'){
          	campos_input_json('NOME'+campo, $('#idreg2').val());
            campos_input_json('CPF'+campo, $('#idreg2').val());
             campos_input_json('IDPESSOA'+campo, $('#idreg2').val());
             $('#formulario'+campo).hide();
          }   
          else{
