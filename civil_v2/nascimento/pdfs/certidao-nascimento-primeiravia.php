...
<body>
	<div id="conteudogeralcertidao">
		...
		<div class="row"><fieldset style="text-align:justify"><legend>FILIAÇÃO</legend>
			<?php
		...
		<div class="row"><fieldset style="text-align:justify"><legend>AVÓS</legend>
			<?php
			if (isset($id_pai)) {
		...
		<div class="row">
			...
			<div class="row">
				...
				<fieldset style="width: 53.5%; max-width: 53.5%;display: inline-table;"><legend>DATA DO REGISTRO POR EXTENSO</legend>
					...
					<div class="row"><fieldset><legend>AVERBAÇÕES/ANOTAÇÕES A ACRESCER</legend><?php echo '<hr style="border:1px dashed black;">'; ?></fieldset></div>
