                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header">
                           ...
                           <form class="form-horizontal" id="formaverbacao" method="POST" enctype="multipart/form-data" action="../bd_INSERTS/insert-anotacao-civil.php?subimit=ok">
...
<!--ANOTAÇÕES--------------------------------------------------------------------------------------------------------------------------->
                    <div class="row clearfix">
                                        <!--div class="col-sm-8">
                                            <label  class="col-md-1 control-form" style="margin-left: -1%;">ATO*:</label>
                                            <div class="col-md-8">
                                                <select name="strAtoEmol" id="strAtoEmol"  class="col-sm-5 form-control" style="background: white!important; " required>
                                                    ...
                                                    <option value="14.10" style="max-width: 100%;font-size: 70%">14.10.1 Retificação... 
                                                    </option>
                                                </select>
                                            </div>
                                        </div-->   
                                        ...
                                        <label  class="col-md-3 control-form">Data:</label>
                                        <div class="col-md-7">
                                        <input type="date" id="dataAverbacao" name="dataAverbacao" value="<?=$data?>" class="form-control naomud" >
                                        </div>
                                        </div>
                                        ...
                                        <label  class="col-md-4 control-form">Motivo*:</label>
                                        <div class="col-md-7">
                                        <select style="margin-left: -17%" name="strMotivoAverbacao" class="form-control naomud">
                                        ...
                                        <label  class="col-md-2 control-form" style="margin-left: -1%;">Espécie*:</label>
                                        <div class="col-md-7"><div class="form-line">
                                        <div class="form-line">
                                        <select  name="especieaverbacao" class="form-control naomud" required="">
                                        <option value="">SELECIONE</option>
                                        ...
                                        <option value="3">Alteração de regime de bens (art. 1.639, parág. 2º CCB);s</option>
                                        ...
                                        <div class="col-sm-8">
                                        <label class="control-form col-md-4">Motivo:*</label>
                                        <div class="col-md-8">
                                        <select style="margin-left: -17%" name="strMotivoAverbacao" class="form-control naomud" required="">
                                        <option value=""></option>


                                        <?php if (isset($_GET['id'])): ?>
                                        <option value="10">NASCIMENTO</option>
                                        <option value="20">ÓBITO</option>
                                        <option value="30">OUTROS</option>
                                        <option value="40">INTERDIÇÃO</option>
                                        <option value="50">AUSÊNCIA</option>
                                        <option value="60">MORTE PRESUMIDA</option>    
                                        <?php endif ?>


                                        <?php if (isset($_GET['idnasc'])): ?>
                                        <option value="10">CASAMENTO</option>
                                        <option value="20">ÓBITO</option>
                                        <option value="30">OUTROS</option>
                                        <option value="40">REESTABELECIMENTO</option>
                                        <option value="50">INTERDIÇÃO</option>
                                        <option value="60">AUSÊNCIA</option>
                                        <option value="70">MORTE PRESUMIDA</option>    
                                        <?php endif ?>
                                        ...
                                        <option value="10">CASAMENTO</option>
                                        <option value="20">NASCIMENTO</option>
                                        <option value="30">OUTROS</option>   
                                        <?php endif ?>
                                        </select>
                                        </div>
                    ...
                    <div class="row">
                              <div class="col-md-12">
                                ...
                                <br>
                                <label >Texto da Anotação:</label><br>
                                <textarea  class="form-control naomud" id="strAverbacao" rows="7" name="strAverbacao" placeholder="" required="">
                                    <?php 
...
<div class="col-sm-3">
            <a id="botaoform" class="btn bg-green  waves-effect waves-float">
            <i class="material-icons">save</i> SALVAR & CONCLUIR</a>
        </div>
</div>        
                                </div>
...
<script src="incluir-averbacao.js"></script>
 <script type="text/javascript">
                $('#botaoform').click(function(){
                                ...
                                swal({
                                title: "Confirmar anotação neste registro?",
