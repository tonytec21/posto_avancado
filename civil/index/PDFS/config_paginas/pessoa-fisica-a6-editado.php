...
<fieldset style="margin-top:7.7px;height:2px;width: 20%; display: inline-block;font-size:9px;position:absolute"><legend>DATA NASCIMENTO</legend> <?=strtoupper( date('d/m/Y', strtotime($key->dataNascimento)))?></fieldset>
</div>
...
<fieldset style="height:2px;width: 31.95%; display: inline-block;font-size:9px"><legend>TEL FIXO</legend> <?=strtoupper($key->strTelefone)?></fieldset>
<fieldset style="height:2px;width: 31.95%; display: inline-block;font-size:9px"><legend>TEL CEL.</legend> <?=strtoupper($key->strTelCelular)?></fieldset>
</div>
