...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
        <div class="header">
        <h2 class="col-md-7">Cadastro de pessoas</h2>
        <a href="cadastro_pessoas_new.php" class="btn bg-indigo"><i class="material-icons">add</i>CADASTRAR NOVA PESSOA</a>
        <a id="delete_cadastro" class="btn bg-red"><i class="material-icons">delete</i>EXCLUIR ESTE CADASTRO</a>
        </div>
        <div class="body">
        <!-- Nav tabs -->
...
<!--======================================================================= DADOS PESSOA =============================================================== -->
    <div role="tabpanel" class="tab-pane fade in active" id="dadosnascimento" >
     <form method="POST" action="update-pessoas.php?id=<?=$id?>">       
            <div class="row clearfix  " style="background: #8c001a; color: white!important"  >
                <br>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-md-8" >
                            <select class="form-control" required="" id="tipo_cadastro" name="tipo_cadastro">
                       ...
                       <div class="col-sm-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-md-10">
                            <select class="form-control" id="setSexo" name="setSexo">
            ...
            <div class="row">
                <div class="col-sm-10"></div>
                    <button type="subimit" name="subimit2" class="btn bg-green  waves-effect waves-float" >
...
<!--========================================================================= SCRIPTS FUNÇÕES E INCLUDES =======================================================
                        ...
                        if ($('#RES_ESTRANGEIRO').is(":checked") == true ) { 
                        ...
                        if ($('#CID_ESTRANGEIRO').is(":checked") == true ) { 
                        ...
                        $("#resultado").html(data);
                          ...
                          <script type="text/javascript">
                            $('#delete_cadastro').click(function(){
                                var id = '<?=$_GET["id"]?>';
                                ...
                                confirmButtonText: "SIM, Exclua o cadastro!",
                                showCancelButton: true,
                                cancelButtonText:'NÃO, CANCELE!',
                                cancelButtonClass: 'bg-blue',
                                ...
                                function(){
                                  ...
                                  window.location="excluir-cadastro-pessoas.php?id="+id;
                                }
                                );
