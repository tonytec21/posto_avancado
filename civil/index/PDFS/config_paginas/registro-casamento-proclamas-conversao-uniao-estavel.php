...
<br>
<div style="width: 100%;" >
 <h3 style="text-align: left;display: inline;margin-left: 1.5cm">LIVRO: D <?=$r->Livro?></h3>
<h3 style="text-align: center; display: inline;margin-left: 5cm;">ORDEM: <?=$r->Ordem?></h3>
<h3 style="text-align: right; display: inline;margin-left: 4cm;">FOLHA: <?=$r->Folha?></h3>
</div>
<br><br>


<h2 style="text-align: center; text-decoration: underline;margin-top: -3px">EDITAL DE CONVERSÃO DE UNIÃO ESTÁVEL EM CASAMENTO</h2>
<h2 style="text-align: center;margin-top: -10px"><?=$r->strMatricula?></h2>

<p style="text-align: justify;font-size: 16px;">
<span style="margin-left: 2cm">Faço saber que pretendem converter a União  Estável  em  Casamento  e
apresentaram documentos exigidos pelo artigo 1.525 do Código Civil  Brasileiro,<?=strtoupper($r->strNomeNoivo)?> e <?=strtoupper($r->strNomeNoiva)?>.
Ele <?php
...
<?php endforeach ?>, onde nasceu no dia
<?php
...
residente e domiciliado em <?=$r->strEnderecoNoivo?>,
...
<?php endforeach ?> rg de número <?=$r->strRGNoiva?>, onde nasceu no dia
<?php
...
<?php endif ?>
 ...
 if ($r->setRegime == 'CP') {
  ...
  ?>
 <?=$regime?>. Se  alguém  souber  de  algum  impedimento,
oponha-o na forma da Lei. Lavro o presente para  ser  afixado  em  Cartório  no
lugar de costume, no prazo  de  15  (quinze)  dias.  Observações:  apresentaram
petição ao Oficial, certidões do Registro Civil dos conviventes e  atestado  de
duas testemunhas. Publicado nesta Serventia a  partir  de  08  de  novembro  de
2016.
