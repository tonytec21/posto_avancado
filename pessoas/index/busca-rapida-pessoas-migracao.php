...
if (isset($_GET['nome'])){
    $busca = $_GET['nome'];
    $query = "select ID, setTipoPessoa, hiddencaminhofoto, strNome, strRazaoSocial,strCPFcnpj, strRG, strOrgaoEm, strProfissao, strNaturalidade, setSexo, strNacionalidade,dataNascimento,setEstadoCivil,strNomeFilhos,strNomeConjuge,strNomeExConjuge,dataCasamento,strCartorioCasamento,strLogradouro,strEmail,strBairro,intUFcidade,strUF,strTelefone,strTelCelular,strNomePai,strNomeMae,dataCadastro,strRepresentante1,strRepresentante2,strRepresentante3,strObservacao,setRegimeBens,dataEmissao,strFicha, RETORNOSELODIGITAL from pessoa_migracao_imperatriz WHERE strNome like '%$busca%' LIMIT 20";
}

else if (isset($_GET['razaoSocial'])){
    $busca = $_GET['razaoSocial'];
    $query = "select ID, setTipoPessoa, hiddencaminhofoto, strNome, strRazaoSocial,strCPFcnpj, strRG, strOrgaoEm, strProfissao, strNaturalidade, setSexo, strNacionalidade,dataNascimento,setEstadoCivil,strNomeFilhos,strNomeConjuge,strNomeExConjuge,dataCasamento,strCartorioCasamento,strLogradouro,strEmail,strBairro,intUFcidade,strUF,strTelefone,strTelCelular,strNomePai,strNomeMae,dataCadastro,strRepresentante1,strRepresentante2,strRepresentante3,strObservacao,setRegimeBens,dataEmissao,strFicha, RETORNOSELODIGITAL from pessoa_migracao_imperatriz WHERE strRazaoSocial like '%$busca%' LIMIT 20";
}

else if (isset($_GET['cpf'])){
    $busca = $_GET['cpf'];
    $query = "select ID, setTipoPessoa, hiddencaminhofoto, strNome, strRazaoSocial,strCPFcnpj, strRG, strOrgaoEm, strProfissao, strNaturalidade, setSexo, strNacionalidade,dataNascimento,setEstadoCivil,strNomeFilhos,strNomeConjuge,strNomeExConjuge,dataCasamento,strCartorioCasamento,strLogradouro,strEmail,strBairro,intUFcidade,strUF,strTelefone,strTelCelular,strNomePai,strNomeMae,dataCadastro,strRepresentante1,strRepresentante2,strRepresentante3,strObservacao,setRegimeBens,dataEmissao,strFicha, RETORNOSELODIGITAL from pessoa_migracao_imperatriz WHERE strCPFcnpj like '%$busca%' LIMIT 20";
}


else if (isset($_GET['numficha'])){
    $busca = $_GET['numficha'];
    $query = "select ID, setTipoPessoa, hiddencaminhofoto, strNome, strRazaoSocial,strCPFcnpj, strRG, strOrgaoEm, strProfissao, strNaturalidade, setSexo, strNacionalidade,dataNascimento,setEstadoCivil,strNomeFilhos,strNomeConjuge,strNomeExConjuge,dataCasamento,strCartorioCasamento,strLogradouro,strEmail,strBairro,intUFcidade,strUF,strTelefone,strTelCelular,strNomePai,strNomeMae,dataCadastro,strRepresentante1,strRepresentante2,strRepresentante3,strObservacao,setRegimeBens,dataEmissao,strFicha, RETORNOSELODIGITAL from pessoa_migracao_imperatriz WHERE strFicha like '%$busca%' LIMIT 20";
}
                        ...
                        foreach($busca_notas as $b):
                         ?>
                                    ...
                                    <td><a href="PDFS/pdf-imagem-pessoa.php?id=<?=$b->ID?>&doc=ok" class="btn waves-effect bg-red"><i class="material-icons">print</i>DOCUMENTO ACERVO</a></td-->
                                        ...
                                        <td> <span style="font-size: 7px; opacity: 0.5" class="badge bg-red"><i class="material-icons">broken_image</i> REIMPRESSÃO NÃO DISPONÍVEL</span></td>
                                        <td> <span style="font-size: 7px; opacity: 0.5" class="badge bg-red"><i class="material-icons">broken_image</i> REIMPRESSÃO NÃO DISPONÍVEL</span></td>
